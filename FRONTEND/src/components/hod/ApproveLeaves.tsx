            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-zinc-100 dark:border-zinc-800">
                ...
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-1 text-xs font-bold uppercase bg-[#1E40AF]/10 text-[#1E40AF] dark:bg-[#2563EB]/40 dark:text-[#3B82F6] rounded-md">
                    {lv.leaveType}
                  </span>
              ...
              <div className="text-xs space-y-2">
                ...
                {lv.facultyApproval?.comment && (
                  <p className="text-[#1E40AF] dark:text-[#3B82F6] bg-[#1E40AF]/10 dark:bg-[#2563EB]/40 p-2.5 rounded-xl font-semibold">
