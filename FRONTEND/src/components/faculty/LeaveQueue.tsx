    ...
    <div className="space-y-6">
      ...
      <div className="pb-2 border-b border-zinc-200 dark:border-zinc-800">
        ...
        <p className="text-xs text-zinc-500 dark:text-zinc-400">
          Review medical certificates, casual leave reasons, and forward approved requests to HOD
        </p>
      </div>

      {pendingLeaves.length === 0 ? (
        <div className="p-8 text-center bg-zinc-50 dark:bg-[#21284C] border border-dashed border-zinc-300 dark:border-[#2D376A] rounded-2xl">
        ...
        <div className="space-y-3">
          {pendingLeaves.map((lv) => (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-zinc-100 dark:border-[#2D376A]">
                <div>
                ...
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-1 text-xs font-bold uppercase bg-[#313866]/10 text-[#313866] dark:bg-[#313866]/50 dark:text-[#8A92D0] rounded-md">
                    {lv.leaveType}
                  </span>
              ...
              <div className="text-xs space-y-2">
                ...
                <p className="text-zinc-600 dark:text-zinc-300 bg-zinc-50 dark:bg-[#161B33]/60 p-3 rounded-xl leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2">
                {lv.attachmentUrl ? (
                  <button
                    ...
                    className="text-xs font-semibold text-[#313866] dark:text-[#8A92D0] hover:underline flex items-center gap-1.5"
                  >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#313866] hover:bg-[#161B33] dark:bg-[#8A92D0] dark:text-[#0D1127] dark:hover:bg-white text-white text-xs font-bold rounded-xl transition-colors shadow-sm flex items-center gap-1"
                  >
