    ...
    return (
      <div className="space-y-6">
        ...
        <div className="p-8 bg-white dark:bg-[#0A0A0A] border border-[#E2E8F0]/80 dark:border-zinc-800 rounded-2xl text-center space-y-4">
          ...
          <div>
            <p className="text-sm font-bold text-[#0F172A] dark:text-zinc-100">Not Assigned as Tutor</p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2">
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 bg-white dark:bg-[#0A0A0A] border border-[#E2E8F0] dark:border-zinc-700 rounded-xl text-xs font-semibold focus:outline-none"
              />
            </div>
            <button
      ...
      {view === 'create' && (
        <div className="bg-white dark:bg-[#0A0A0A] border border-[#E2E8F0]/80 dark:border-zinc-800 rounded-2xl p-6 shadow-sm space-y-5">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold text-[#0F172A] dark:text-zinc-100">Send Tutor Circular</h3>
            <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full p-2.5 bg-[#F7F9FC] dark:bg-zinc-800 border border-[#E2E8F0] dark:border-zinc-700 rounded-xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-amber-500"
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                className="w-full p-2.5 bg-[#F7F9FC] dark:bg-zinc-800 border border-[#E2E8F0] dark:border-zinc-700 rounded-xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-amber-500 resize-none"
              />
            </div>
          ...
          {/* Recipient Preview */}
          <div className="p-3.5 bg-[#F7F9FC] dark:bg-[#0A0A0A] border border-[#E2E8F0] dark:border-zinc-800 rounded-2xl">
          ...
          <div className="space-y-4 text-xs">
            <div className="p-4 bg-[#F7F9FC] dark:bg-[#0A0A0A] border border-[#E2E8F0] dark:border-zinc-800 rounded-2xl space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2 border-t border-[#E2E8F0] dark:border-zinc-800">
                <div>
                  <span className="text-[10px] font-bold text-[#000000] dark:text-[#64748B] uppercase">Target Class</span>
